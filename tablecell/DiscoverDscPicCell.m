...
#import "Header.h"
@implementation DiscoverDscPicCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        //单元格的宽度
        /// 1.添加ImageView
        self.cellImage = [[UIImageView alloc] initWithFrame: CGRectMake(20*size,154*size, 210*size,142*size)];
        ...
        self.cellPariseIcon = [[UILabel alloc] initWithFrame:CGRectMake(271*size,273*size, 110*size, 28*size)];
        ...
        self.cellParise = [[UILabel alloc] initWithFrame:CGRectMake(310*size,273*size, 110*size, 28*size)];
        ...
        /// 5.添加简介
        self.cellDsc = [[UILabel alloc] initWithFrame:CGRectMake(270*size,154*size, 460*size, 80*size)];
